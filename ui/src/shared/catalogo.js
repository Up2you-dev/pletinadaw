...
export const CATALOGO = [
  {
    ...
    dispositivos: [
      ...
      { nombre: 'Válvulas', detalle: 'estilo Pultec', fase: 3, tipo: 'valvulas', lista: true },
      { nombre: 'Consola', detalle: 'canal británico', fase: 3, tipo: 'consola', lista: true },
      { nombre: 'Peine', detalle: 'gráfico de 31 bandas', fase: 3, tipo: 'peine', lista: true },
    ],
  },
  {
    grupo: 'Dinámica',
    dispositivos: [
      ...
      { nombre: 'Remache', detalle: 'FET estilo 1176', fase: 3, tipo: 'remache', lista: true },
      { nombre: 'Ópto', detalle: 'estilo LA-2A', fase: 3, tipo: 'opto', lista: true },
      { nombre: 'Lámpara', detalle: 'vari-mu de máster', fase: 3, tipo: 'lampara', lista: true },
    ],
  },
  {
    grupo: 'Reverbs',
    dispositivos: [
      ...
      { nombre: 'Convolución', detalle: 'IRs de verdad', fase: 2, tipo: 'convolucion', lista: true },
      { nombre: 'Muelle', detalle: 'spring con su boing', fase: 3, tipo: 'muelle', lista: true },
      { nombre: 'Espejismo', detalle: 'shimmer', fase: 3, tipo: 'espejismo', lista: true },
    ],
  },
  {
    ...
    dispositivos: [
      ...
      { nombre: 'Eco', detalle: 'cinta estilo RE-201', fase: 3, tipo: 'eco', lista: true },
      { nombre: 'Multitap', detalle: 'ecos al tempo con anchura', fase: 3, tipo: 'multitap', lista: true },
      { nombre: 'Coro', detalle: 'y flanger y fase', fase: 3, tipo: 'coro', lista: true },
      { nombre: 'Trémolo', detalle: 'y autopan', fase: 3, tipo: 'tremolo', lista: true },
    ],
  },
  {
    grupo: 'Saturación',
    dispositivos: [
      ...
      { nombre: 'Triodo', detalle: 'válvula', fase: 3, tipo: 'triodo', lista: true },
      { nombre: 'Sumadora', detalle: 'consola apurada', fase: 3, tipo: 'sumadora', lista: true },
      { nombre: 'Machacadora', detalle: 'bitcrusher lo-fi', fase: 3, tipo: 'machacadora', lista: true },
    ],
  },
  {
    grupo: 'Mastering',
